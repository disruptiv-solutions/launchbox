...
/**
 * Simple site config so this template is easy to reuse.
 * Update these values (or wire them to env/props) and the UI updates everywhere.
 */
const SITE = {
  name: 'Your Company',
...
const Home: NextPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      setSubmitting(true);
      // === Replace this with your API/CRM submission ===
            ...
            <div className="mx-auto mt-10 max-w-3xl">
              {submitted ? (
                ...
                <form
                  ...
                  className="grid gap-6 rounded-xl border border-gray-200 bg-white p-6 shadow-sm ring-1 ring-black/5 dark:border-gray-800 dark:bg-gray-900"
                  noValidate
                >
